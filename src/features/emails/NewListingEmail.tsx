...
export function NewListingEmail(): JSX.Element {
    return (
        <Html>
            <Head />
            <Preview>
            ...
            <Body style={main}>
                <Container style={container}>
                    <Section style={box}>
                        <Img
                            src={`${SITE_URL}/assets/company-logo.jpg`}
                            width="49"
                            height="21"
                            alt={siteTitle}
                        />
                        ...
                        <Text style={paragraph}>
                            ...
                            Youre now ready to make live transactions with
                            Stripe!
                        </Text>
                        <Text style={paragraph}>
                        ...
                        <Button
                            ...
                            pY={10}
                            style={button}
                            href={`${SITE_URL}/${path.marketplace}`}>
                            View your Stripe Dashboard
                        </Button>
                        <Hr style={hr} />
                        <Text style={paragraph}>
                            If you havent finished your integration, you might
                            find our{' '}
                        ...
                        <Text style={paragraph}>
                            Once youre ready to start accepting payments, you
